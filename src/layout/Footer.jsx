    ...
    <footer className="bg-custom-green text-white py-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h4 className="text-lg font-semibold mb-4">Acerca de Dream Reserve</h4>
            <p className="text-sm">Hacemos realidad tus sueños de viaje con las mejores ofertas y destinos.</p>
          </div>
          <div>
